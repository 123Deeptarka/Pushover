...
def user_input_features():
    D=st.sidebar.number_input("D",format="%.3f")
    LD =st.sidebar.number_input("L/D",format="%.3f")   
    fc =st.sidebar.number_input("fc",format="%.3f")
    fyl =st.sidebar.number_input("fyl",format="%.3f")
    fyt =st.sidebar.number_input("fyt",format="%.3f")
    pl =st.sidebar.number_input("pl",format="%.3f")
    pt =st.sidebar.number_input("pt",format="%.3f")
    Ny =st.sidebar.number_input("Ny",format="%.3f")
